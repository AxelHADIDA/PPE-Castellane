	...
	if( isset($_POST['btn-login']) ) {
		...
		if (!$error) {
			...
			if( $count == 1 && $row['userPass']==$password ) {
				...
				$errMSG = "Informations incorrectes réesayez !";
			}
...
<div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="on">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	<button id="btn-logreg" type="submit" class="btn btn-block" name="btn-login">Se connecter</button>
            </div>
            ...
            <div class="form-group">
            	<a href="register.php" class="liens">S'inscrire ici.</a>
            	<br><br>
            	<a href="../index.html" class="liens">Retourner à l'acceuil.</a>
            </div>
